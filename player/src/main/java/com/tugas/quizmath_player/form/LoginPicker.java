 ...
 * @author syafiq
 */
public class LoginPicker extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(LoginPicker.class.getName());

    /**
     * Creates new form LoginPicker
     */
    public LoginPicker() {
        initComponents();
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/images/logosekul.jpeg"));
Image scaled = icon.getImage().getScaledInstance(100, 100, Image.SCALE_SMOOTH);

 // set gambar ke label yang sudah dibuat NetBeans
    jLabel3.setIcon(new ImageIcon(scaled));
    jLabel3.setText(""); // hapus tulisan "jLabel3"
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(125, 168, 198));

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));

        jLabel1.setBackground(new java.awt.Color(255, 143, 143));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new LoginPicker().setVisible(true));
    }
